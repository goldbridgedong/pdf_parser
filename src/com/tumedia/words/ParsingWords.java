...
public class ParsingWords {
    public static final String PDF = "results/words/Hackers_Toeic_2013_Listening.pdf";
    public static final String RESULT = "results/words/Hackers_Toeic_2013_Listening_rect.pdf";
    public static final String TEXT = "results/words/Hackers_Toeic_2013_Listening.txt";
    public static final String COORD_IMAGE = "resources/words/page001.tif";
    ...
    public static void main(String[] args) throws DocumentException, IOException {
        ParsingWords example = new ParsingWords();
